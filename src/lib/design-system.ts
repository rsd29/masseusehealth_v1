export const typography = {
  heroHeading:
    "text-2xl font-normal leading-none tracking-[-0.035em] sm:text-3xl lg:text-5xl",
  heroStatement:
    "text-2xl font-normal leading-tight tracking-[-0.035em] sm:text-4xl lg:text-6xl",
  actionLabel: "text-sm font-semibold",
  supportBody: "text-sm",
